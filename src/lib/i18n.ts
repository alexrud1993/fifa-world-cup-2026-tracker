...
const translations = {
  en: {
    ...
    "updateMonitor.title": "Update monitor",
    "updateMonitor.status.waiting": "Waiting",
    "updateMonitor.status.syncing": "Syncing",
    "updateMonitor.status.updated": "Updated",
    "updateMonitor.status.failed": "Failed",
    "updateMonitor.status.live": "Live",
    "updateMonitor.liveCadence": "Refreshing about every 5 minutes during live matches.",
    "updateMonitor.hourlyCadence": "Refreshing hourly between matches.",
    "updateMonitor.mode": "Mode",
    "updateMonitor.modeValue": "snapshot + public refresh",
    "updateMonitor.betweenMatches": "Between matches",
    "updateMonitor.hourly": "hourly",
    "updateMonitor.synced": "Synchronized",
    "updateMonitor.localSnapshot": "Local snapshot",
    "updateMonitor.publicRefresh": "Public refresh",
    "updateMonitor.noApiKeys": "No API keys used",
  ...
  uk: {
    ...
    "updateMonitor.title": "Монітор оновлень",
    "updateMonitor.status.waiting": "Очікування",
    "updateMonitor.status.syncing": "Синхронізація",
    "updateMonitor.status.updated": "Оновлено",
    "updateMonitor.status.failed": "Помилка",
    "updateMonitor.status.live": "Наживо",
    "updateMonitor.liveCadence": "Під час live-матчів оновлення кожні ~5 хв.",
    "updateMonitor.hourlyCadence": "Між матчами оновлення щогодини.",
    "updateMonitor.mode": "Режим",
    "updateMonitor.modeValue": "snapshot + public refresh",
    "updateMonitor.betweenMatches": "Між матчами",
    "updateMonitor.hourly": "щогодини",
    "updateMonitor.synced": "Синхронізовано",
    "updateMonitor.localSnapshot": "Локальний snapshot",
    "updateMonitor.publicRefresh": "Публічне оновлення",
    "updateMonitor.noApiKeys": "API-ключі не використовуються",
